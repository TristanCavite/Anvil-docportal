  ...
  <tr>
    <td valign="top" style="width: 28%; padding: 10px;">
      ...
      <ul style="margin-top:0;">
        <li><a href="../authentication/authentication-sign-up.md">Sign up (FR0.0)</a></li>
        <li><a href="../authentication/authentication-sign-in.md">Sign in (FR0.0)</a></li>
        <li><a href="../authentication/authentication-forgot-password.md">Forgot Password (FR0.0)</a></li>
        <li><a href="../authentication/authentication-logout.md">Logout (FR0.0)</a></li>
      </ul>
    ...
    <!-- RIGHT: HOMEPAGE MEDIA + DESCRIPTION + USE CASE (like your sample) -->
