...
<table border="1" cellpadding="0" cellspacing="0" style="width: 100%; font-size: 12px; table-layout:fixed;">
  <tr>
    ...
    <td valign="top" style="width: 28%; padding: 10px;">
      ...
      <ul style="margin-top:0;">
        <li><a href="-item.md">Reserve Item (FR6.0)</a></li>
    ...
    <td valign="top" style="width: 72%; padding: 10px;">
      <p><a href="../homepage/project-homepage.md">Homepage</a> &gt; <strong>Accept Decline Reservation</strong></p>
      <h3 style="margin-top:0;">Accept Decline Reservation</h3>
      <br>
    </td>
  </tr>
  <tr>
